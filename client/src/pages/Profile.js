            ...
            <div className="profile">
                <div className="profile-header">
                    ...
                    <div className="follow-container">
                        <Button onClick={(event) => setToggleButton1(!toggleButton1)} className={toggleButton1 ? classes.button : classes.activeButton}>Follow</Button>
                        <Button onClick={(event) => setToggleButton2(!toggleButton2)} className={toggleButton2 ? classes.button : classes.activeButton}>Message</Button>
                    </div>
                </div>
                <Following />
            </div>
